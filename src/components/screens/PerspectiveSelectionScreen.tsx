    ...
    return (
        <div className="min-h-screen p-6 text-white relative">
            ...
            >
                ...
                <h2 className="text-6xl font-black mb-4 tracking-tight uppercase leading-none">Choose a <span className="text-slate-500">Perspective</span></h2>
            </motion.div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-[1400px] mx-auto items-stretch px-4 pb-24">
                {PERSPECTIVES.map((p, idx) => {
                    ...
                    return (
                        <motion.button
                            ...
                            whileHover={{ y: -5 }}
                            onClick={() => onSelect(p)}
                            className="group relative flex flex-col items-start p-10 rounded-lg bg-white/[0.02] border border-white/[0.05] hover:border-white/[0.2] hover:bg-white/[0.04] transition-all text-left overflow-hidden h-full min-h-[420px]"
                        >
                            <div className={clsx(
                            ...
                            <div className="w-full flex justify-between items-start mb-12">
                                <Icon className={clsx("w-6 h-6 opacity-30 group-hover:opacity-100 transition-opacity",
                            ...
                            <h3 className="text-3xl font-black mb-4 leading-none uppercase tracking-tighter group-hover:tracking-tight transition-all duration-500">
                                {displayTitle}
                            </h3>

                            <p className="text-slate-400 mb-12 font-medium text-sm leading-relaxed max-w-[280px]">
                                {p.description}
                            </p>

                            <div className="flex flex-col gap-3 mb-12 flex-grow">
            ...
            <div className="w-full p-8 px-12 flex flex-col md:flex-row justify-between items-center text-[10px] text-slate-700 font-bold uppercase tracking-widest border-t border-white/[0.02] gap-6">
                <div className="flex items-center gap-3">

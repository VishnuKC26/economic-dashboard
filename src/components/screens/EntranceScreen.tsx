            ...
            <div className="relative z-10 min-h-screen flex flex-col justify-end p-8 sm:p-12 md:p-24 lg:p-32 w-full">
                ...
                >
                    <div className="space-y-4 md:space-y-6">
                        ...
                        <p className="text-base md:text-xl text-slate-400 font-medium max-w-2xl leading-tight opacity-70">
                    ...
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        onClick={onStart}
                        className="flex items-center gap-4 md:gap-6 px-10 md:px-14 py-4 md:py-5 border border-white/20 text-white rounded-none font-bold tracking-[0.2em] md:tracking-[0.3em] transition-all hover:border-white uppercase text-xs md:text-sm group"
                    >
                        EXPLORE
